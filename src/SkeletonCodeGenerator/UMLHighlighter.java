...
public class UMLHighlighter extends DefaultStyledDocument {
    ...
    public UMLHighlighter() {
        ...
        StyleConstants.setFontSize(classname, 15);
        StyleConstants.setUnderline(classname, true);
    ...
    /**
     * Gibt den Text zurück (mit Überprüfung)
     * @param start
     * @param count
     * @return
     */
