...
/**
 * Help Klasse
 * Zeigt das Hilfemenü an, wird identifiziert anhand den HELP_ Konstanten.
 * @author Coolo
 */
public class Help extends javax.swing.JFrame {
    ...
    /**
     * Erzeugt das Help Objekt
     * @param typ Welchen Text soll es haben?
     */
    public Help(int typ) {
        String txt="";
        initComponents();
        if (typ == HELP_ATTRIBUTES) {
            ...
            txt="Every text which does not begin with +,- or # will be ignored.";
